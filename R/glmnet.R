...
#'
#' @param object Fitted "glmnet" model object or a "relaxed" model (which inherits from class "glmnet").
...
#' @param nonzero whether to only return non-zero estimates
...
#' @export
coef.glmnet <- function(object, s = NULL, exact = FALSE, nonzero = TRUE, ...) {

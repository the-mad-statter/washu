...
#' @param show.search whether to show/enable the add/edit search feature in add/edit modals
...
dteditmod <- function(input, output, session,
  ...
  populate_search_results <- function(email, typeName) {
    ...
    shiny::updateSelectInput(inputId = paste0(name, typeName, "icts_member"), selected = icts_member_selected)
  }

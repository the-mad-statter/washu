...
#' @param suffix the suffixes used to disambiguate non-joined duplicate variables during the join
#'
#' @return a dataframe with duplicate variables coalesced and the original variants dropped
#' @export
#'
#' @examples

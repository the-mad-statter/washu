...
#'
#' @return matrix with n rows and n-1 columns where n is the number of factor levels
#' @export
#' 
#' @references 
#' https://stats.idre.ucla.edu/r/library/r-library-contrast-coding-systems-for-categorical-variables/#backward
#' 
#' @seealso \link[stats]{contrast}
#'
#' @examples
...
contr.backward_difference <- function(fct) {
  ...
  colnames(mx) <- paste0("[", levels[2:n], "-", levels[1:(n-1)], "]", sep = "")
  mx
}
